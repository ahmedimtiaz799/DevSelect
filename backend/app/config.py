...
class Settings(BaseSettings):
    ...
    CV_PREVIEW_MAX_CHARS: int = 12000
    ...
    CHECKPOINT_RETENTION_TTL_HOURS: int = 24
    CHECKPOINT_CLEANUP_INTERVAL_SECONDS: int = 3600
    CHECKPOINT_CLEANUP_BATCH_SIZE: int = 100
    DEV_MOCK_EVALUATION: bool = False
    DAILY_BUDGET_ENABLED: bool = True
    GLOBAL_EVALS_PER_DAY: int = 2
    GLOBAL_EVALS_PER_MONTH: int = 50
    USER_EVALS_PER_DAY: int = 1
    USER_EVALS_LIFETIME: int = 5
    FOLLOWUPS_PER_EVALUATION: int = 2
    FOLLOWUPS_PER_USER_DAY: int = 3
    DAILY_USER_ESTIMATED_TOKEN_LIMIT: int = 1000000
    DAILY_GLOBAL_ESTIMATED_TOKEN_LIMIT: int = 10000000
    EVALUATION_LOCK_TTL_SECONDS: int = 1800
    EVALUATION_LOCK_RETRY_AFTER_SECONDS: int = 60
